...
public class form extends JFrame {
	...
	public form(int X, int Y) {
		...
		comboBox_Course.setModel(new DefaultComboBoxModel(new String[] { "None", "BSc", "MSc", "BEng", "MEng", "Other" }));
		comboBox_Course.setBounds(889, 408, 118, 44);
		getContentPane().add(comboBox_Course);

		JComboBox comboBox_Year = new JComboBox();
		comboBox_Year.setModel(new DefaultComboBoxModel(new String[] { "0", "I", "II", "III", "IV+" }));
		...
		JLabel lblBranch = new JLabel("Line");
		...
		comboBox_Branch.setModel(new DefaultComboBoxModel(new String[] { "None",
		...
		btnNext.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textField_Name.getText().isEmpty() || textField_Email.getText().isEmpty()
						|| String.valueOf(textField_Password.getPassword()).isEmpty()
						|| textField_Roll.getText().isEmpty()) {
					...
					try {
						...
						myWriter.write("Name is " + S.getName() + "\n");
						myWriter.write("Email is " + S.getEmail() + "\n");
						myWriter.write("Roll number is " + S.getRollNo() + "\n");
						myWriter.write("Password is " + S.getPassword() + "\n");
						myWriter.write("Profession is " + S.getBranch() + "\n");
						myWriter.write("Degree is " + S.getCourse() + "\n");
						myWriter.write("Year: " + S.getYear());
						myWriter.close();
					...
					Description frame1 = new Description(S, (int) getLocationOnScreen().getX(),
