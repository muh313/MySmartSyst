...
public class main {
	...
	private void initialize() {
		...
		frmMySmartSyst.getContentPane().add(lblMadanMohanMalaviya);
		...
		JLabel lblQuizSystem = new JLabel("Smart System");
		...
		frmMySmartSyst.getContentPane().add(lblQuizSystem);
		...
		btnStart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				form frame0 = new form((int)frmMySmartSyst.getLocationOnScreen().getX(), (int)frmMySmartSyst.getLocationOnScreen().getY());
